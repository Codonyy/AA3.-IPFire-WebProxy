...
- IPFire 2.29 (x86_64) amb interfícies **GREEN** (192.168.4.254/24) i **RED** (10.0.2.2/24)
- Client a la xarxa GREEN amb IP 192.168.2.1
- Navegador per accedir al panell de control `https://192.168.2.254:444`
